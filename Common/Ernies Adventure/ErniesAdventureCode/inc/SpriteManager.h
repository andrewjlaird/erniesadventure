...
class SpriteManager
{
   public:
      ...
      SpriteManager(SceneManager& sceneManager, DisplayManager& displayManager, VariableManager& variableManager);
      ...
      Character* parseCharacterFile(std::ifstream& scenefile, std::string sceneName, std::vector<Point> startPoints);
